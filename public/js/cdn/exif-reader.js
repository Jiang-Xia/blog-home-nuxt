!(function (e, t) {
  ...
  return (function () {
    ...
    var e = {
        d: function (t, n) {
          for (var r in n)
            e.o(n, r) && !e.o(t, r) && Object.defineProperty(t, r, { enumerable: 1, get: n[r] });
        },
        o: function (e, t) {
    ...
    function ce(e, t) {
      var n = Q.length;
      return e.getUint16(t) === X && a(e, t + w, n) === Q && 0 === e.getUint8(t + w + n);
    }
    function fe(e, t) {
      var n = ee.length;
                        ...
                        o.itemType === He
                          ? ((o.contentType = u(e, r)),
                            t + i > (r += o.contentType.length + 1) &&
                              ((o.contentEncoding = u(e, r)), (r += o.contentEncoding.length + 1)))
                          : 1970432288 === o.itemType &&
                            ((o.itemUri = u(e, r)), (r += o.itemUri.length + 1))),
                      o
                    );
                  })(e, t, c, i + 1, r)
      ...
      et = {
        parseAppMarkers: function (e, t) {
          if (
            ...
            return tt(h.USE_EXIF ? { hasAppMarkers: 1, tiffHeaderOffset: 0 } : {}, 'tiff', 'TIFF');
          if (
            h.USE_JPEG &&
            (function (e) {
            ...
            return tt(
              (function (e) {
                for (var t, n, r, i, o, a, u, c, f, s = E; s + w + 5 <= e.byteLength; ) {
                  if (h.USE_FILE && ie(e, s)) (t = e.getUint16(s + x)), (n = s + x);
                  else if (h.USE_FILE && oe(e, s)) (t = e.getUint16(s + x)), (r = s + x);
                  else if (h.USE_JFIF && ce(e, s)) (t = e.getUint16(s + x)), (i = s + T);
                  else if (h.USE_EXIF && fe(e, s)) (t = e.getUint16(s + x)), (o = s + O);
                  else if (h.USE_XMP && se(e, s))
                    u || (u = []), (t = e.getUint16(s + x)), u.push(de(s, t));
                  else if (h.USE_XMP && le(e, s))
                    u || (u = []), (t = e.getUint16(s + x)), u.push(pe(s, t));
                  else if (h.USE_IPTC && me(e, s)) (t = e.getUint16(s + x)), (a = s + M);
                  ...
                  } else if (h.USE_MPF && ue(e, s)) (t = e.getUint16(s + x)), (f = s + D);
                  else {
                    if (!ge(e, s)) {
                      if (ve(e, s)) {
                        s++;
          ...
          if (
            ...
            return tt(
              (function (e, t) {
                for (var n = { hasAppMarkers: 0 }, r = he.length; r + ye + Se <= e.byteLength; ) {
                  if (h.USE_PNG_FILE && Me(e, r))
                    ...
                    void 0 !== i &&
                      ((n.hasAppMarkers = 1),
                      (n.xmpChunks = [
                        { dataOffset: i, length: e.getUint32(r + be) - (i - (r + Ce)) },
                      ]));
                  } else if (Re(e, r, t)) {
                    n.hasAppMarkers = 1;
                    var o = a(e, r + Ie, Se);
                  ...
                  } else if (ke(e, r)) (n.hasAppMarkers = 1), (n.tiffHeaderOffset = r + Ce);
              ...
              (function (e) {
                for (var t, n, r, i, o = 12, u = 0; o + 8 < e.byteLength; ) {
                  var c = a(e, o, 4),
                    f = e.getUint32(o + 4, 1);
                  h.USE_EXIF && 'EXIF' === c
                    ? ((u = 1), (t = 'Exif\0\0' === a(e, o + 8, 6) ? o + 8 + 6 : o + 8))
                    : h.USE_XMP && 'XMP ' === c
                      ? ((u = 1), (n = [{ dataOffset: o + 8, length: f }]))
                      : h.USE_ICC && 'ICCP' === c
                        ? ((u = 1),
                          (r = [{ offset: o + 8, length: f, chunkNumber: 1, chunksTotal: 1 }]))
                        : 'VP8X' === c && ((u = 1), (i = o + 8)),
                    (o += 8 + (f % 2 == 0 ? f : f + 1));
                }
                return {
          ...
          if (
            ...
            return tt(
              (function (e) {
                var t = [];
                return t.push({ dataOffset: Ze, length: e.byteLength }), { xmpChunks: t };
              })(e),
              'xml',
              'XML',
            );
    ...
    var dt = l({}, rt, {
      ...
      yt = lt(
        lt(
          lt(
            lt(lt(lt(lt(lt({}, pt, dt), '1st', rt), mt, dt), 'gps', ut), gt, ct),
            'mpf',
            h.USE_MPF ? ft : {},
          ),
          vt,
    ...
    function wt(e, t, n, r, i, o) {
      var a = It.getTypeSize('SHORT'),
        u = {},
        c = (function (e, t, n) {
          return t + It.getTypeSize('SHORT') <= e.byteLength ? It.getShortAt(e, t, n) : 0;
        })(e, r, i);
      r += a;
    ...
    function Tt(e, t, n, r, i) {
      ...
      for (var a = 0; a < r; a++) o.push(At[n](e, t, i)), (t += It.typeSizes[n]);
      return n === It.tagTypes.ASCII ? (o = It.getAsciiValue(o)) : 1 === o.length && (o = o[0]), o;
    }
    function Ot(e) {
    ...
    var Mt = 'Exif IFD Pointer',
      ...
      kt = {
        read: function (e, t, n) {
          ...
          return {
            tags: (i = Lt((i = Nt((i = Dt(i, e, t, r, n)), e, t, r, n)), e, t, r, n)),
            byteOrder: r,
          };
        },
      };
    ...
    function Nt(e, t, n, r, i) {
      return void 0 !== e[Ft] ? l(e, wt(t, 'gps', n, n + e[Ft].value, r, i)) : e;
    }
    ...
    var _t = {
        read: function (e, t, n) {
          ...
          return (function (e, t, n, r) {
            ...
            for (var i = [], o = 0; o < Math.ceil(n.MPEntry.value.length / Bt); o++) {
              i[o] = {};
              var a = Gt(n.MPEntry.value, o * Bt, It.getTypeSize('LONG'), r);
              (i[o].ImageFlags = jt(a)), (i[o].ImageFormat = zt(a)), (i[o].ImageType = Vt(a));
              var u = Gt(n.MPEntry.value, o * Bt + 4, It.getTypeSize('LONG'), r);
              i[o].ImageSize = { value: u, description: '' + u };
              var c = Ht(o, n.MPEntry, r, t);
              i[o].ImageOffset = { value: c, description: '' + c };
              var f = Gt(n.MPEntry.value, o * Bt + 12, It.getTypeSize('SHORT'), r);
              i[o].DependentImage1EntryNumber = { value: f, description: '' + f };
              var s = Gt(n.MPEntry.value, o * Bt + 14, It.getTypeSize('SHORT'), r);
              (i[o].DependentImage2EntryNumber = { value: s, description: '' + s }),
    ...
    function Kt(e, t, n, r) {
      if (!(8 + 3 * n > r)) {
        for (var i = [], o = 0; o < n; o++) {
          var a = t + 8 + 3 * o;
          i.push([It.getByteAt(e, a), It.getByteAt(e, a + 1), It.getByteAt(e, a + 2)]);
        }
    ...
    var on = {
      iptc: {
        ...
        346: { name: 'Coded Character Set', description: cn, encoding_name: cn },
        356: 'UNO',
        376: {
          name: 'ARM Identifier',
          description: function (e) {
    ...
    var fn = function (e, t) {
      ...
      sn = {
        read: function (e, t, n) {
          try {
            if (Array.isArray(e))
              return mn(new DataView(Uint8Array.from(e).buffer), { size: e.length }, 0, n);
            var r = (function (e, t) {
    ...
    function gn(e, t, n, r, i) {
      ...
      var u = (function (e, t, n) {
        ...
        c = { id: o, name: vn(on.iptc[o], o, u), value: u, description: hn(on.iptc[o], u, n, r) };
      return (
        (function (e) {
          ...
          return (
            ...
            ((n = (function (e, t, n) {
              return (
                ...
                })(e, wn() ? Reflect.construct(t, n || [], Tn(e).constructor) : t.apply(e, n))
              );
      ...
      for (var n in e) {
        ...
        Array.isArray(r) || (r = [r]),
          r.forEach(function (e) {
            l(t, Bn(e.attributes)), 'object' === Pn(e.value) && l(t, Wn(e.value));
          });
      }
      return t;
    }
    function Bn(e) {
      ...
      for (var n in e)
        try {
          Gn(n) && (t[zn(n)] = { value: e[n], attributes: {}, description: Vn(e[n], n) });
        } catch (e) {}
      return t;
    }
    function Gn(e) {
    ...
    function Vn(e) {
      ...
      if ('object' === Pn(e))
        return (function (e) {
          var t = [];
          for (var n in e) t.push(''.concat(Hn(n), ': ').concat(Vn(e[n].value)));
          return t.join('; ');
        })(e);
      try {
        return t && 'function' == typeof Sn[t] ? Sn[t](e) : decodeURIComponent(escape(e));
      } catch (t) {
        return e;
      }
    }
    ...
    function Yn(e, t) {
      ...
      void 0 !== e.value['rdf:Description'] && (e = e.value['rdf:Description']),
        l(
          ...
          (function (e) {
            var t = {};
            for (var n in e.value) 'rdf:value' === n || jn(n) || (t[zn(n)] = e.value[n].value);
            return t;
          })(e),
        );
      var r = (function (e) {
    ...
    function Kn(e) {
      ...
      for (var n in e.attributes)
        'rdf:parseType' === n || 'rdf:resource' === n || jn(n) || (t[zn(n)] = e.attributes[n]);
      return t;
    }
    function qn(e) {
      return (
                ...
                ir(
                  ir(
                    ir(
                      ...
                      1,
                      { description: 'Closed subpath Bezier knot, linked', path: cr },
                    ),
                    2,
                    { description: 'Closed subpath Bezier knot, unlinked', path: cr },
                  ),
                  3,
                  {
    ...
    var yr = {
      ...
      Sr = {
        ...
        36: {
          ...
          value: function (e, t) {
            return (
              (n = e.buffer.slice(t, t + 4)), String.fromCharCode.apply(null, new Uint8Array(n))
            );
            var n;
          },
        },
    ...
    function Mr(e) {
      ...
      if (Fr(t.slice(36, 40)) !== Pr) throw Error('ICC profile: missing signature');
      if (
        (function (e) {
      ...
      for (var d = e.getUint32(128), p = 132, m = 0; m < d; m++) {
        ...
        if (y === Ar) {
          ...
          for (
            var b = e.getUint32(v + 8), I = e.getUint32(v + 12), C = v + 16, U = [], P = 0;
            P < b;
            P++
          ) {
            var A = a(e, C + 0, 2),
    ...
    var kr = {
      ...
      Lr = {
        read: function (e, t, n, r) {
          ...
          return (
            (function (e) {
              return e.PentaxModelID && e.PentaxModelID.value === Dr.K3_III && e.LevelInfo;
            })(a) &&
              ((a = l(
                {},
                a,
              ...
              o.push(
                c.then(function (e) {
                  var t,
                    ...
                    u = e.description;
                  try {
                    if (h.USE_EXIF && si(o, a)) return { __exif: kt.read(di(a), ri, r).tags };
                    if (h.USE_IPTC && li(o, a)) return { __iptc: sn.read(di(a), 0, r) };
                    if (o && !si(o, a) && !li(o, a))
                      return (
                        (t = {}),
    ...
    function ii(e, t, n, r, i) {
      for (var o, a = [], u = [], c = [], f = qr, s = g, l = 0; l < n && t + l < e.byteLength; l++)
        if (f !== $r) {
          if (f === ei) {
          ...
          (s = oi({ type: r, dataView: e, offset: t + l })), r === Ae && (l += ti), (f = ai(r, f));
      if (s !== g && !i) return {};
      var p = v(
        o,
        s,
    ...
    function Ui(e, t) {
      var n =
        It.getByteAt(e, t) + 256 * It.getByteAt(e, t + 1) + 65536 * It.getByteAt(e, t + 2) + 1;
    ...
    function ji(e) {
      ...
      if (
        ...
        if (h.USE_PHOTOSHOP && k.ImageSourceData) {
        ...
        if (h.USE_TIFF && h.USE_ICC && k.ICC_Profile && !Hi(P)) {
          var B = Ir.read(k.ICC_Profile.value, [
            { offset: 0, length: k.ICC_Profile.value.length, chunkNumber: 1, chunksTotal: 1 },
          ]);
          r ? (p.icc = B) : (p = l({}, p, B));
        }
      ...
      if (h.USE_PNG && h.USE_PNG_FILE && void 0 !== E) {
        d = 1;
        var X = Gr.read(e, E);
        r ? ((p.png = p.png ? l({}, p.png, X) : X), (p.pngFile = X)) : (p = l({}, p, X));
      }
      if (
        h.USE_PNG &&
        (function (e) {
      ...
      var ee =
        (h.USE_JPEG || h.USE_WEBP) && h.USE_EXIF && h.USE_THUMBNAIL && Fi.get(e, p.Thumbnail, I);
      if (
        (ee ? ((d = 1), (p.Thumbnail = ee)) : delete p.Thumbnail,
        v && (r ? (p.file || (p.file = {}), (p.file.FileType = v)) : (p.FileType = v), (d = 1)),
        !d)
      )
      ...
      function ne(e) {
        if (r) {
          ...
          (p.png = p.png ? l({}, p.png, e) : e), (p.pngText = p.pngText ? l({}, p.png, e) : e);
        } else
          delete (p = l({}, p, e.__exif ? e.__exif : {}, e.__iptc ? e.__iptc : {}, e)).__exif,
            delete p.__iptc;
      }
    }
    function zi(e) {
