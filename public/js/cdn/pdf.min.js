    ...
    var __webpack_modules__ = [
        ...
        (t, e) => {
          ...
          e.normalizeUnicode = function normalizeUnicode(t) {
            ...
            return t.replaceAll(l, (t, e, i) => (e ? e.normalize('NFKC') : c.get(i)));
          };
          ...
          e.Util = class Util {
            ...
            static bezierBoundingBox(t, e, i, s, n, a, r, o) {
              ...
              for (; _--; ) {
                p = l[_];
                A = 1 - p;
                c[0][_] = A * A * A * t + 3 * A * A * p * i + 3 * A * p * p * n + p * p * p * r;
                c[1][_] = A * A * A * e + 3 * A * A * p * s + 3 * A * p * p * a + p * p * p * o;
              }
              c[0][v] = t;
              c[1][v] = e;
              c[0][v + 1] = r;
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            ...
            const d = t.verbosity,
              ...
              I = t.canvasFactory || new DefaultCanvasFactory({ ownerDocument: w }),
              O = t.filterFactory || new DefaultFilterFactory({ docId: i, ownerDocument: w });
            (0, _util.setVerbosityLevel)(d);
            const L = { canvasFactory: I, filterFactory: O };
            if (!D) {
              L.cMapReaderFactory = new m({ baseUrl: p, isCompressed: g });
            ...
            h.promise
              .then(function () {
                ...
                return Promise.all([t, o]).then(function ([t, s]) {
                  if (e.destroyed) throw new Error('Loading aborted');
                  const n = new _message_handler.MessageHandler(i, t, h.port),
                    a = new WorkerTransport(n, e, s, B, L);
                  e._transport = a;
                  n.send('Ready', null);
                });
              })
          ...
          class PDFPageProxy {
            ...
            render({
              ...
              const h = this._transport.getRenderingIntent(i, s, c);
              this.#s = !1;
              this.#n();
          ...
          class PDFObjects {
            ...
            #m(t) {
              const e = this.#g[t];
              return e || (this.#g[t] = { capability: new _util.PromiseCapability(), data: null });
            }
            get(t, e = null) {
              if (e) {
                const i = this.#m(t);
          ...
          class InternalRenderTask {
            ...
            cancel(t = null, e = 0) {
              ...
              this.cancelled = !0;
              this.gfx?.endDrawing();
              this._canvas && InternalRenderTask.#b.delete(this._canvas);
              this.callback(
                t ||
        ...
        (t, e, i) => {
          ...
          class AnnotationEditor {
            ...
            constructor(t) {
              ...
              const {
                rotation: e,
                rawDims: { pageWidth: i, pageHeight: n, pageX: a, pageY: r },
            ...
            translateInPage(t, e) {
              this.#F(this.pageDimensions, t, e);
            ...
            setDims(t, e) {
              ...
              this.#S || (this.div.style.height = `${((100 * e) / s).toFixed(2)}%`);
            }
            fixDims() {
              ...
              this.#S || n || (t.height = `${((100 * parseFloat(e)) / r).toFixed(2)}%`);
            }
            ...
            #R() {
              ...
              for (const e of t) {
                ...
                t.addEventListener('pointerdown', this.#D.bind(this, e));
              }
              this.div.prepend(this.#E);
            }
            #D(t, e) {
              e.preventDefault();
              this.#x = [e.clientX, e.clientY];
              const i = this.#I.bind(this, t),
                s = this.div.draggable;
              ...
              window.addEventListener(
                ...
                () => {
                  ...
                  this.div.draggable = s;
                  this.parent.div.classList.remove(n);
            ...
            #I(t, e) {
              ...
              const [o, l] = this.parentDimensions,
                ...
                d = this.width,
                u = this.height,
                p = AnnotationEditor.MIN_SIZE / o,
                g = AnnotationEditor.MIN_SIZE / l;
              let m;
              const round = (t) => Math.round(1e4 * t) / 1e4,
                updatePosition = (t, e) => {
                  const [i, s] = this.parentDimensions;
                  this.setDims(i * t, s * e);
                  this.fixAndSetPosition();
                };
              switch (t) {
                case 'topLeft': {
                  if (Math.sign(a) * Math.sign(r) < 0) return;
                  const t = Math.hypot(a, r),
                    e = Math.hypot(d * o, u * l),
                    i = round(c + d),
                    s = round(h + u),
                    n = Math.max(Math.min(1 - Math.sign(a) * (t / e), 1 / d, 1 / u), p / d, g / u),
                    f = round(d * n),
                    b = round(u * n),
                    A = i - f,
                    _ = s - b;
                ...
                case 'topMiddle': {
                  const t = round(this.y + u),
                    e = round(Math.max(g, Math.min(1, u - r / l))),
                    i = t - e;
                  m = () => {
                    this.height = e;
                    this.y = i;
                ...
                case 'topRight': {
                  ...
                  const t = Math.hypot(a, r),
                    ...
                    i = round(h + this.height),
                    s = Math.max(Math.min(1 + Math.sign(a) * (t / e), 1 / d, 1 / u), p / d, g / u),
                    n = round(d * s),
                    c = round(u * s),
                    f = i - c;
                  m = () => {
                ...
                case 'middleRight': {
                  const t = round(Math.max(p, Math.min(1, d + a / o)));
                  m = () => {
                    this.width = t;
                    updatePosition(t, u);
                  };
                ...
                case 'bottomRight': {
                  ...
                  const t = Math.hypot(a, r),
                    e = Math.hypot(this.width * o, this.height * l),
                    i = Math.max(Math.min(1 + Math.sign(a) * (t / e), 1 / d, 1 / u), p / d, g / u),
                    s = round(d * i),
                    n = round(u * i);
                  m = () => {
                    this.width = s;
                ...
                case 'bottomMiddle': {
                  const t = round(Math.max(g, Math.min(1, u + r / l)));
                  m = () => {
                    this.height = t;
                    updatePosition(d, t);
                  };
                ...
                case 'middleLeft': {
                  const t = round(c + d),
                    e = round(Math.max(p, Math.min(1, d - a / o))),
                    i = t - e;
                  m = () => {
                    this.width = e;
                    this.x = i;
              ...
              this.addCommands({
                ...
                mustExec: !0,
                type: s.AnnotationEditorParamsType.RESIZE,
            ...
            render() {
              ...
              this.div.addEventListener('focusin', this.#C);
              this.div.addEventListener('focusout', this.#w);
            ...
            static deserialize(t, e, i) {
              ...
              const [n, a] = s.pageDimensions,
                [r, o, l, c] = s.getRectInCurrentCoords(t.rect, a);
              s.x = r / n;
              s.y = o / a;
              s.width = l / n;
              s.height = c / a;
            ...
            remove() {
              this.div.removeEventListener('focusin', this.#C);
              this.div.removeEventListener('focusout', this.#w);
        ...
        (t, e, i) => {
          ...
          class IdManager {
            #O = 0;
            getId() {
              return `${s.AnnotationEditorPrefix}${this.#O++}`;
            }
          }
          class ImageManager {
            #L = (0, s.getUuid)();
                ...
                if ('image/svg+xml' === t.type) {
                  const e = new FileReader(),
                    ...
                    n = new Promise((t, n) => {
                      ...
                      e.onload = () => {
                        s.src = i.svgUrl = e.result;
                      };
                      s.onerror = e.onerror = n;
                    });
                  e.readAsDataURL(t);
                  await n;
          ...
          class CommandManager {
            ...
            add({
              ...
              if (-1 === this.#H) {
                this.#U.length > 0 && (this.#U.length = 0);
                this.#H = 0;
                this.#U.push(r);
                return;
              }
              if (n && this.#U[this.#H].type === s) {
                a && (r.undo = this.#U[this.#H].undo);
                this.#U[this.#H] = r;
                return;
              }
              const o = this.#H + 1;
              if (o === this.#z) this.#U.splice(0, 1);
              else {
                this.#H = o;
                o < this.#U.length && this.#U.splice(o);
              }
              this.#U.push(r);
            }
          ...
          class KeyboardManager {
            ...
            exec(t, e) {
              ...
              const i = this.callbacks.get(this.#W(e));
              if (!i) return;
              const {
                callback: s,
          ...
          class AnnotationEditorUIManager {
            ...
            constructor(t, e, i, s) {
              this.#bt = t;
              this.#Z = e;
              this.#Z._on('editingaction', this.#ht);
              this.#Z._on('pagechanging', this.#dt);
              this.#Z._on('scalechanging', this.#ut);
              this.#Z._on('rotationchanging', this.#pt);
              this.#$ = i.annotationStorage;
              this.#tt = i.filterFactory;
              this.#at = s;
              this.viewParameters = { realScale: n.PixelsPerInch.PDF_TO_CSS_UNITS, rotation: 0 };
            }
            destroy() {
              this.#At();
              this.#Z._off('editingaction', this.#ht);
              this.#Z._off('pagechanging', this.#dt);
              this.#Z._off('scalechanging', this.#ut);
              this.#Z._off('rotationchanging', this.#pt);
            ...
            get hcmFilter() {
              return (0, s.shadow)(
                this,
                'hcmFilter',
                this.#at ? this.#tt.addHCMFilter(this.#at.foreground, this.#at.background) : 'none',
              );
            }
            ...
            #_t() {
              window.addEventListener('keydown', this.#ct, { capture: !0 });
            }
            #At() {
              window.removeEventListener('keydown', this.#ct, { capture: !0 });
            }
            #vt() {
              document.addEventListener('copy', this.#rt);
              document.addEventListener('cut', this.#ot);
              document.addEventListener('paste', this.#lt);
            }
            #yt() {
              document.removeEventListener('copy', this.#rt);
              document.removeEventListener('cut', this.#ot);
              document.removeEventListener('paste', this.#lt);
            }
            copy(t) {
              t.preventDefault();
              this.#G && this.#G.commitOrRemove();
            ...
            #xt(t) {
              Object.entries(t).some(([t, e]) => this.#gt[t] !== e) &&
                this.#Z.dispatch('annotationeditorstateschanged', {
                  source: this,
                  details: Object.assign(this.#gt, t),
                });
            }
            #Ct(t) {
              this.#Z.dispatch('annotationeditorparamschanged', { source: this, details: t });
            }
            setEditingState(t) {
              if (t) {
                this.#_t();
                this.#vt();
                this.#xt({
                  isEditing: this.#st !== s.AnnotationEditorType.NONE,
                  isEmpty: this.#wt(),
            ...
            updateToolbar(t) {
              t !== this.#st &&
                this.#Z.dispatch('switchannotationeditormode', { source: this, mode: t });
            }
            updateParams(t, e) {
              if (this.#J) {
                for (const i of this.#nt) i.updateParams(t, e);
                for (const i of this.#J) i.updateDefaultParams(t, e);
              }
            }
            #Tt() {
              if (!this.#it) {
            ...
            getEditors(t) {
              const e = [];
              for (const i of this.#q.values()) i.pageIndex === t && e.push(i);
              return e;
            }
            getEditor(t) {
              return this.#q.get(t);
            ...
            removeEditor(t) {
              this.#q.delete(t.id);
              this.unselect(t);
              (t.annotationElementId && this.#Y.has(t.annotationElementId)) ||
                this.#$?.remove(t.id);
            }
            addDeletedAnnotationElement(t) {
              this.#Y.add(t.annotationElementId);
              t.deleted = !0;
            }
            ...
            removeDeletedAnnotationElement(t) {
              this.#Y.delete(t.annotationElementId);
              t.deleted = !1;
            }
            #St(t) {
            ...
            addCommands(t) {
              this.#X.add(t);
              this.#xt({ hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#wt() });
            }
            #wt() {
              if (0 === this.#q.size) return !0;
              if (1 === this.#q.size) for (const t of this.#q.values()) return t.isEmpty();
              return !1;
            }
            delete() {
              this.commitOrRemove();
            ...
            selectAll() {
              ...
              this.#Et(this.#q.values());
            }
            unselectAll() {
              if (this.#G) this.#G.commitOrRemove();
            ...
            translateSelectedEditors(t, e, i = !1) {
              ...
              this.#ft = setTimeout(() => {
                ...
                this.addCommands({
                  cmd: () => {
                    for (const t of a) this.#q.has(t.id) && t.translateInPage(s, n);
                  },
                  undo: () => {
                    for (const t of a) this.#q.has(t.id) && t.translateInPage(-s, -n);
                  },
          ...
          class DOMFilterFactory extends s.BaseFilterFactory {
            ...
            get #Bt() {
              if (!this.#Mt) {
                ...
                e.top = e.left = 0;
                e.zIndex = -1;
                const i = this.#Ft.createElementNS(a, 'svg');
                i.setAttribute('width', 0);
                i.setAttribute('height', 0);
                this.#Mt = this.#Ft.createElementNS(a, 'defs');
                t.append(i);
                i.append(this.#Mt);
            ...
            addHCMFilter(t, e) {
              const i = `${t}-${e}`;
              if (this.#Dt === i) return this.#It;
              this.#Dt = i;
              this.#It = 'none';
              this.#Rt?.remove();
              if (!t || !e) return this.#It;
              const s = this.#zt(t);
              t = n.Util.makeHexColor(...s);
              const a = this.#zt(e);
              e = n.Util.makeHexColor(...a);
              this.#Bt.style.color = '';
              if (('#000000' === t && '#ffffff' === e) || t === e) return this.#It;
              ...
              this.#jt(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), c);
              this.#It = `url(#${l})`;
              return this.#It;
            }
              ...
              const getSteps = (t, e, i) => {
                  ...
                  for (let t = 0; t <= i; t++) {
                    const e = Math.round(o + t * n),
                      i = a + t * r;
                    for (let t = c; t <= e; t++) s[t] = i;
                    c = e + 1;
                  }
                  for (let t = c; t < 256; t++) s[t] = s[c - 1];
                  return s.join(',');
                },
            ...
            destroy(t = !1) {
              if (!t || (!this.#It && !this.#Nt)) {
                if (this.#Mt) {
                  this.#Mt.parentNode.parentNode.remove();
                  this.#Mt = null;
                }
                if (this.#kt) {
                  this.#kt.clear();
            ...
            #Wt(t, e, i) {
              const s = this.#Ft.createElementNS(a, e);
        ...
        (t, e, i) => {
          ...
          e.FontLoader = class FontLoader {
            ...
            _prepareFontLoadEvent(t, e) {
              ...
              const h = 1482184792;
              let d = int32(c, 16);
              for (i = 0, n = l.length - 3; i < n; i += 4) d = (d - h + int32(l, i)) | 0;
              i < l.length && (d = (d - h + int32(l + 'XXX', i)) | 0);
              c = spliceString(c, 16, 4, (0, s.string32)(d));
        ...
        (t, e, i) => {
          ...
          function drawImageAtIntegerCoords(t, e, i, s, a, r, o, l, c, h) {
          ...
          class CanvasExtraState {
            ...
            updateCurvePathMinMax(t, e, i, n, a, r, o, l, c, h) {
              const d = s.Util.bezierBoundingBox(e, i, n, a, r, o, l, c);
              if (h) {
          ...
          function composeSMask(t, e, i, s) {
            const n = s[0],
              ...
              o = s[3] - a;
            if (0 !== r && 0 !== o) {
              !(function genericComposeSMask(t, e, i, s, n, a, r, o, l, c, h) {
                const d = !!a,
                  u = d ? a[0] : 0,
                  p = d ? a[1] : 0,
                  g = d ? a[2] : 0,
                ...
                for (let n = 0; n < s; n += f) {
                  const a = Math.min(f, s - n),
                    b = t.getImageData(o - c, n + (l - h), i, a),
          ...
          class CanvasGraphics {
            ...
            _scaleImage(t, e) {
              ...
              for (; (r > 2 && l > 1) || (o > 2 && c > 1); ) {
                ...
                n = this.cachedCanvases.getCanvas(h, e, i);
                a = n.context;
                a.clearRect(0, 0, e, i);
            ...
            paintImageMaskXObjectRepeat(t, e, i = 0, a = 0, r, o) {
              ...
              for (let t = 0, n = o.length; t < n; t += 2) {
                const n = s.Util.transform(c, [e, i, a, r, o[t], o[t + 1]]),
        ...
        (t, e, i) => {
          ...
          function drawTriangle(t, e, i, s, n, a, r, o) {
            ...
            for (let t = P; t <= k; t++) {
              ...
              L = v - (v - w) * e;
              N = y - (y - T) * e;
              const i = Math.round(Math.min(M, I)),
        ...
        (t, e, i) => {
          ...
          function convertBlackAndWhiteToRGBA({
            ...
            for (let s = 0; s < a; s++) {
              ...
              if (0 === u) continue;
              const s = e < p ? t[e++] : 255;
              for (let t = 0; t < u; t++) i[g++] = s & (1 << (7 - t)) ? h : c;
            }
          ...
          e.MessageHandler = class MessageHandler {
            constructor(t, e, i) {
              ...
              this._onComObjOnMessage = (t) => {
                ...
                } else e.streamId ? this.#Xt(e) : s(e.data);
              };
              ...
              const e = t.streamId,
                ...
                d = {
                  enqueue(t, r = 1, o) {
                    ...
                    a.postMessage(
                      { sourceName: i, targetName: n, stream: c, streamId: e, chunk: t },
                      o,
                    );
                  },
                  close() {
        ...
        (t, e, i) => {
          ...
          e.Metadata = class Metadata {
            ...
            getAll() {
              return (0, s.objectFromMap)(this.#Yt);
            }
            has(t) {
          ...
          e.OptionalContentConfig = class OptionalContentConfig {
            ...
            constructor(t) {
              ...
              if (null !== t) {
                ...
                for (const e of t.groups)
                  this.#te.set(e.id, new OptionalContentGroup(e.name, e.intent));
                if ('OFF' === t.baseState) for (const t of this.#te.values()) t._setVisible(a, !1);
            ...
            #se(t) {
              ...
              for (let n = 1; n < e; n++) {
                const e = t[n];
                let a;
                if (Array.isArray(e)) a = this.#se(e);
                else {
                  if (!this.#te.has(e)) {
            ...
            isVisible(t) {
              ...
              if ('OCG' === t.type) {
                ...
                return this.#te.get(t.id).visible;
              }
              if ('OCMD' === t.type) {
                if (t.expression) return this.#se(t.expression);
            ...
            getOrder() {
              return this.#te.size ? (this.#ie ? this.#ie.slice() : [...this.#te.keys()]) : null;
            }
            getGroups() {
              return this.#te.size > 0 ? (0, s.objectFromMap)(this.#te) : null;
            }
            getGroup(t) {
            ...
            getHash() {
              ...
              for (const [e, i] of this.#te) t.update(`${e}:${i.visible}`);
        ...
        (t, e, i) => {
          ...
          function appendText(t, e, i) {
            ...
            t._textDivs.push(n);
            const c = s.Util.transform(t._transform, e.transform);
            ...
            const u = Math.hypot(c[2], c[3]),
              p =
                ...
                (function getAscent(t, e) {
                  ...
                  s.clearRect(0, 0, a, a);
                  s.strokeText('g', 0, 0);
                  let h = s.getImageData(0, 0, a, a).data;
                  c = 0;
          ...
          class TextLayerRenderTask {
            constructor({
              ...
              const { pageWidth: c, pageHeight: h, pageX: d, pageY: u } = i.rawDims;
        ...
        (t, e, i) => {
          ...
          class AnnotationEditorLayer {
            ...
            constructor({
              ...
              const h = [r.FreeTextEditor, o.InkEditor, c.StampEditor];
              ...
              this.#re = n;
              this.viewport = a;
              this.#pe.addLayer(this);
            }
            get isEmpty() {
              return 0 === this.#ce.size;
            }
            updateToolbar(t) {
            ...
            addInkEditorIfNeeded(t) {
              if (!t && this.#pe.getMode() !== s.AnnotationEditorType.INK) return;
              if (!t)
              ...
              this.#me({ offsetX: 0, offsetY: 0 }).setInBackground();
            }
            setEditingState(t) {
            ...
            enable() {
              ...
              for (const i of e) {
                i.hide();
                if (this.#pe.isDeletedAnnotationElement(i.data.id)) continue;
            ...
            disable() {
              ...
              if (this.#re) {
                ...
                for (const i of e) {
                  const { id: e } = i.data;
                  t.has(e) || this.#pe.isDeletedAnnotationElement(e) || i.show();
                }
              }
              this.#ge();
            ...
            enableClick() {
              this.div.addEventListener('pointerdown', this.#le);
              this.div.addEventListener('pointerup', this.#oe);
            }
            disableClick() {
              this.div.removeEventListener('pointerdown', this.#le);
              this.div.removeEventListener('pointerup', this.#oe);
            }
            attach(t) {
              this.#ce.set(t.id, t);
              const { annotationElementId: e } = t;
              e &&
                this.#pe.isDeletedAnnotationElement(e) &&
                this.#pe.removeDeletedAnnotationElement(t);
            }
            detach(t) {
              this.#ce.delete(t.id);
              this.#ne?.removePointerInTextLayer(t.contentDiv);
              !this.#ue && t.annotationElementId && this.#pe.addDeletedAnnotationElement(t);
            }
            remove(t) {
              this.detach(t);
              this.#pe.removeEditor(t);
              t.div.style.display = 'none';
              setTimeout(() => {
                t.div.style.display = '';
                t.div.remove();
                t.isAttachedToDOM = !1;
                document.activeElement === document.body && this.#pe.focusMainContainer();
              }, 0);
              this.#de || this.addInkEditorIfNeeded(!1);
            }
            #fe(t) {
              if (t.parent !== this) {
                if (t.annotationElementId) {
                  this.#pe.addDeletedAnnotationElement(t.annotationElementId);
            ...
            add(t) {
              ...
              t.onceAdded();
              this.#pe.addToAnnotationStorage(t);
            }
            moveEditorInDOM(t) {
            ...
            deserialize(t) {
              switch (t.annotationType ?? t.annotationEditorType) {
                ...
                case s.AnnotationEditorType.STAMP:
                  return c.StampEditor.deserialize(t, this, this.#pe);
              }
              return null;
            }
            #me(t) {
            ...
            pointerup(t) {
              const { isMac: e } = s.FeatureTest.platform;
              if (!(0 !== t.button || (t.ctrlKey && e)) && t.target === this.div && this.#he) {
                this.#he = !1;
                this.#ae ? this.#me(t) : (this.#ae = !0);
              }
            }
            pointerdown(t) {
              if (this.#he) {
              ...
              this.#he = !0;
              const i = this.#pe.getActive();
              this.#ae = !i || i.isEmpty();
            }
            drop(t) {
              const e = t.dataTransfer.getData('text/plain'),
                i = this.#pe.getEditor(e);
              if (!i) return;
              t.preventDefault();
              t.dataTransfer.dropEffect = 'move';
              this.#fe(i);
              const s = this.div.getBoundingClientRect(),
                n = t.clientX - s.x,
                a = t.clientY - s.y;
              i.translate(n - i.startX, a - i.startY);
            ...
            destroy() {
              ...
              this.div = null;
              this.#ce.clear();
              this.#pe.removeLayer(this);
            }
            #ge() {
              this.#de = !0;
              for (const t of this.#ce.values()) t.isEmpty() && t.remove();
              this.#de = !1;
            }
            render({ viewport: t }) {
              this.viewport = t;
              (0, l.setLayerDimensions)(this.div, t);
              (0, a.bindEvents)(this, this.div, ['dragover', 'drop']);
              for (const t of this.#pe.getEditors(this.pageIndex)) this.add(t);
              this.updateMode();
            }
            update({ viewport: t }) {
              this.#pe.commitOrRemove();
              this.viewport = t;
              (0, l.setLayerDimensions)(this.div, { rotation: t.rotation });
              this.updateMode();
            }
            get pageDimensions() {
        ...
        (t, e, i) => {
          ...
          class FreeTextEditor extends a.AnnotationEditor {
            #Ae = this.editorDivBlur.bind(this);
            #_e = this.editorDivFocus.bind(this);
            ...
            constructor(t) {
              ...
              this.#Ce = t.fontSize || FreeTextEditor._defaultFontSize;
            }
            static initialize(t) {
              this._l10nPromise = new Map(
                ['free_text2_default_content', 'editor_free_text2_aria_label'].map((e) => [
                  e,
                  t.get(e),
                ]),
              );
            ...
            get propertiesToUpdate() {
              return [
                [s.AnnotationEditorParamsType.FREETEXT_SIZE, this.#Ce],
                [s.AnnotationEditorParamsType.FREETEXT_COLOR, this.#Se],
              ];
            }
            #Te(t) {
              const setFontsize = (t) => {
                  this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
                  this.translate(0, -(t - this.#Ce) * this.parentScale);
                  this.#Ce = t;
                  this.#ke();
                },
                e = this.#Ce;
            ...
            getInitialTranslation() {
              ...
              return [
                ...
                -(FreeTextEditor._internalPadding + this.#Ce) * t,
              ];
            }
            rebuild() {
              super.rebuild();
            ...
            enableEditMode() {
              if (!this.isInEditMode()) {
                ...
                this.editorDiv.addEventListener('focus', this.#_e);
                this.editorDiv.addEventListener('blur', this.#Ae);
                this.editorDiv.addEventListener('input', this.#ve);
              }
            }
            disableEditMode() {
              if (this.isInEditMode()) {
                ...
                this.div.setAttribute('aria-activedescendant', this.#xe);
                this.div.draggable = !0;
                this.editorDiv.removeEventListener('keydown', this.#ye);
                this.editorDiv.removeEventListener('focus', this.#_e);
                this.editorDiv.removeEventListener('blur', this.#Ae);
                this.editorDiv.removeEventListener('input', this.#ve);
            ...
            render() {
              ...
              this.editorDiv.setAttribute('id', this.#xe);
              this.enableEditing();
              ...
              i.fontSize = `calc(${this.#Ce}px * var(--scale-factor))`;
              i.color = this.#Se;
                ...
                if (this.annotationElementId) {
                  ...
                  switch (this.rotation) {
                    ...
                    case 90:
                      ...
                      break;
                    case 180:
                      d = t - this.width + (n[0] - c) / o;
                      u = e - (n[1] - h) / l;
                      [a, r] = [-a, -r];
                      break;
                    case 270:
                      d = t + (n[0] - c - this.height * l) / o;
                      u = e + (n[1] - h - this.width * o) / l;
                      [a, r] = [-r, a];
                  }
            ...
            static deserialize(t, e, i) {
              ...
              a.#Ce = t.fontSize;
              a.#Se = s.Util.makeHexColor(...t.color);
              a.#Ee = t.value;
            ...
            serialize(t = !1) {
              ...
              const e = FreeTextEditor._internalPadding * this.parentScale,
                ...
                n = a.AnnotationEditor._colorManager.convert(
                  this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Se,
                ),
                r = {
                  annotationType: s.AnnotationEditorType.FREETEXT,
                  color: n,
              ...
              if (t) return r;
              if (this.annotationElementId && !this.#De(r)) return null;
              r.id = this.annotationElementId;
              return r;
            }
            #De(t) {
              const { value: e, fontSize: i, color: s, rect: n, pageIndex: a } = this.#we;
              return (
                t.value !== e ||
                t.fontSize !== i ||
        ...
        (t, e, i) => {
          ...
          class AnnotationElement {
            ...
            _createContainer(t) {
              ...
              const { width: h, height: d } = getRectDims(e.rect),
            ...
            get _commonActions() {
              const setColor = (t, e, i) => {
                const s = i.detail[t];
                i.target.style[e] = r.ColorConverters[`${s[0]}_HTML`](s.slice(1));
              };
            ...
            _createQuadrilaterals() {
              ...
              d.append(u);
              for (const [, { x: i, y: s }, { x: a, y: h }] of t) {
            ...
            _getElementsByName(t, e = null) {
              ...
              for (const s of document.getElementsByName(t)) {
                ...
                n !== e && h.has(s) && i.push({ id: n, exportValue: t, domElement: s });
              }
              return i;
            }
            show() {
          ...
          class WidgetAnnotationElement extends AnnotationElement {
            ...
            _setEventListeners(t, e, i) {
              for (const [s, n] of e)
                ('Action' === n || this.data.actions?.[n]) && this._setEventListener(t, s, n, i);
            }
          ...
          class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              n.type = 'checkbox';
              n.name = e.baseFieldName || e.fieldName;
          ...
          class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              s.name = this.data.baseFieldName || this.data.fieldName;
              s.tabIndex = c;
          ...
          class PopupElement {
            #Ne = null;
            #Be = this.#Ue.bind(this);
            #je = this.#ze.bind(this);
            ...
            constructor({
              ...
              u &&
                (this.#Ne = l.l10n.get('annotation_date_string', {
              ...
              for (const t of this.trigger) {
                t.addEventListener('click', this.#He);
                t.addEventListener('mouseenter', this.#je);
                t.addEventListener('mouseleave', this.#Be);
              }
              this.#bt.hidden = !0;
              d && this.#We();
            }
            render() {
              ...
              const {
                ...
                r = (this.#Ke = document.createElement('div'));
              r.className = 'popup';
              if (this.#Se) {
                const t = (r.style.outlineColor = s.Util.makeHexColor(...this.#Se));
                if (CSS.supports('background-color', 'color-mix(in srgb, red 30%, white)'))
                  r.style.backgroundColor = `color-mix(in srgb, ${t} 30%, white)`;
                else {
                  const t = 0.7;
                  r.style.backgroundColor = s.Util.makeHexColor(
                    ...this.#Se.map((e) => Math.floor(t * (255 - e) + e)),
                  );
                }
              }
              ...
              o.append(c);
              ({ dir: c.dir, str: c.textContent } = this.#Qe);
              r.append(o);
              if (this.#Ne) {
            ...
            #We() {
              ...
              if (this.#Xe) {
                this.#ze();
                this.#bt.addEventListener('click', this.#He);
              } else {
                this.#Ue();
                this.#bt.removeEventListener('click', this.#He);
              }
            }
            #ze() {
              this.#Ke || this.render();
              if (this.isVisible) this.#Xe && this.#bt.classList.add('focused');
              else {
                this.#bt.hidden = !1;
                this.#bt.style.zIndex = parseInt(this.#bt.style.zIndex) + 1e3;
              }
            }
            #Ue() {
              this.#bt.classList.remove('focused');
              if (!this.#Xe && this.isVisible) {
                this.#bt.hidden = !0;
                this.#bt.style.zIndex = parseInt(this.#bt.style.zIndex) - 1e3;
              }
            }
            forceHide() {
              this.#Ze = this.isVisible;
              this.#Ze && (this.#bt.hidden = !0);
            }
            maybeShow() {
              if (this.#Ze) {
                this.#Ze = !1;
          ...
          class LineAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              const t = this.data,
                ...
                n = (this.#ti = this.svgFactory.createElement('svg:line'));
          ...
          class SquareAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              const t = this.data,
                ...
                a = (this.#ei = this.svgFactory.createElement('svg:rect'));
          ...
          class CircleAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              const t = this.data,
                ...
                s = this.svgFactory.create(e, i, !0),
                n = t.borderStyle.width,
                a = (this.#ii = this.svgFactory.createElement('svg:ellipse'));
          ...
          class PolylineAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              n = n.join(' ');
              const a = (this.#si = this.svgFactory.createElement(this.svgElementName));
              ...
              s.append(a);
              this.container.append(s);
              t.popupRef || this._createPopup(a, t);
              return this.container;
            }
            getElementsToTriggerPopup() {
              return this.#si;
          ...
          class InkAnnotationElement extends AnnotationElement {
            ...
            render() {
              ...
              for (const e of t.inkLists) {
                ...
                n.setAttribute('stroke', 'transparent');
                n.setAttribute('fill', 'transparent');
                t.popupRef || this._createPopup(n, t);
                s.append(n);
              }
              this.container.append(s);
              return this.container;
          ...
          e.AnnotationLayer = class AnnotationLayer {
            ...
            #li(t, e) {
              ...
              this.div.append(t);
              this.#ne?.moveElementInDOM(this.div, t, i, !1);
            }
            async render(t) {
              ...
              for (const t of e) {
                ...
                i.annotationEditorType > 0 && this.#oi.set(i.data.id, i);
                const n = i.render();
            ...
            getEditableAnnotations() {
              return Array.from(this.#oi.values());
            }
            getEditableAnnotation(t) {
              return this.#oi.get(t);
            }
          };
        },
        (t, e) => {
          ...
          e.ColorConverters = class ColorConverters {
            ...
            static RGB_HTML([t, e, i]) {
              return `#${makeColorComp(t)}${makeColorComp(e)}${makeColorComp(i)}`;
            }
            static T_HTML() {
              return '#00000000';
            }
            ...
            static render(t) {
              ...
              for (; o.length > 0; ) {
                ...
                if (l.children && l.children.length > 0) o.push([l, -1, d]);
                  ...
                  const t = document.createTextNode(l.value);
                  s.XfaText.shouldBuildText(h) && c.push(t);
                  d.append(t);
                }
              }
        ...
        (t, e, i) => {
          ...
          class InkEditor extends n.AnnotationEditor {
            #hi = 0;
            #di = 0;
            #ui = this.canvasContextMenu.bind(this);
            #pi = this.canvasPointermove.bind(this);
            #gi = this.canvasPointerleave.bind(this);
            #mi = this.canvasPointerup.bind(this);
            #fi = this.canvasPointerdown.bind(this);
            #bi = new Path2D();
            #Ai = !1;
            #_i = !1;
            #vi = !1;
            ...
            static initialize(t) {
              this._l10nPromise = new Map(
                ['editor_ink_canvas_aria_label', 'editor_ink2_aria_label'].map((e) => [
                  e,
                  t.get(e),
                ]),
              );
            ...
            enableEditMode() {
              if (!this.#Ai && null !== this.canvas) {
                super.enableEditMode();
                this.div.draggable = !1;
                this.canvas.addEventListener('pointerdown', this.#fi);
              }
            }
            disableEditMode() {
              if (this.isInEditMode() && null !== this.canvas) {
                ...
                this.canvas.removeEventListener('pointerdown', this.#fi);
              }
            }
            onceAdded() {
              this.div.draggable = !this.isEmpty();
            ...
            #Ii(t, e) {
              this.canvas.addEventListener('contextmenu', this.#ui);
              this.canvas.addEventListener('pointerleave', this.#gi);
              this.canvas.addEventListener('pointermove', this.#pi);
              this.canvas.addEventListener('pointerup', this.#mi);
              this.canvas.removeEventListener('pointerdown', this.#fi);
              this.isEditing = !0;
              if (!this.#vi) {
                this.#vi = !0;
              ...
              this.#xi = () => {
                this.#Oi();
                this.#xi && window.requestAnimationFrame(this.#xi);
              };
              window.requestAnimationFrame(this.#xi);
            }
            #Li(t, e) {
              ...
              if (n.length <= 2) {
                ...
                if (3 === n.length) {
                  this.#bi = a = new Path2D();
                  a.moveTo(...n[0]);
                }
                this.#Ni(a, ...n.at(-3), ...n.at(-2), t, e);
              }
            }
            #Bi() {
            ...
            #Ui(t, e) {
              ...
              this.#Bi();
              let i;
              if (1 !== this.currentPath.length) i = this.#ji();
              else {
                const s = [t, e];
            ...
            canvasPointerdown(t) {
              if (0 === t.button && this.isInEditMode() && !this.#Ai) {
                this.setInForeground();
                t.preventDefault();
                'mouse' !== t.type && this.div.focus();
                this.#Ii(t.offsetX, t.offsetY);
              }
            }
            canvasContextMenu(t) {
              t.preventDefault();
            ...
            #Hi(t) {
              this.canvas.removeEventListener('pointerleave', this.#gi);
              this.canvas.removeEventListener('pointermove', this.#pi);
              this.canvas.removeEventListener('pointerup', this.#mi);
              this.canvas.addEventListener('pointerdown', this.#fi);
              setTimeout(() => {
                this.canvas.removeEventListener('contextmenu', this.#ui);
              }, 10);
              this.#Ui(t.offsetX, t.offsetY);
              this.addToAnnotationStorage();
            ...
            #Mi() {
              this.#yi = new ResizeObserver((t) => {
                const e = t[0].contentRect;
                e.width && e.height && this.setDimensions(e.width, e.height);
              });
              this.#yi.observe(this.div);
            }
            get isResizable() {
              return !this.isEmpty() && this.#Ai;
            }
            render() {
              if (this.div) return this.div;
              let t, e;
            ...
            #Xi(t, e, i, s) {
              ...
              for (const e of this.paths) {
                ...
                n.push({
                  bezier: InkEditor.#Vi(i, s, this.rotation),
                  points: InkEditor.#Vi(a, s, this.rotation),
                });
              }
              return n;
            }
            #Ki() {
              ...
              for (const a of this.paths)
                for (const [r, o, l, c] of a) {
                  const a = s.Util.bezierBoundingBox(...r, ...o, ...l, ...c);
                  t = Math.min(t, a[0]);
                  i = Math.min(i, a[1]);
                  e = Math.max(e, a[2]);
                  n = Math.max(n, a[3]);
            ...
            #Gi() {
              return this.#Ai ? Math.ceil(this.thickness * this.parentScale) : 0;
            }
            #Ti(t = !1) {
              ...
              const e = this.#Ki(),
                i = this.#Gi();
              this.#di = Math.max(n.AnnotationEditor.MIN_SIZE, e[2] - e[0]);
              this.#hi = Math.max(n.AnnotationEditor.MIN_SIZE, e[3] - e[1]);
              const s = Math.ceil(i + this.#di * this.scaleFactor),
                a = Math.ceil(i + this.#hi * this.scaleFactor),
            ...
            static deserialize(t, e, i) {
              ...
              const f = r.#Ki();
              r.#di = Math.max(n.AnnotationEditor.MIN_SIZE, f[2] - f[0]);
              r.#hi = Math.max(n.AnnotationEditor.MIN_SIZE, f[3] - f[1]);
              r.#Wi(c, h);
              return r;
            }
            serialize() {
        ...
        (t, e, i) => {
          ...
          class StampEditor extends s.AnnotationEditor {
            ...
            #ss() {
              if (this.#Ji) {
                this._uiManager.imageManager.getFromId(this.#Ji).then((t) => {
                  if (t) {
                    this.#Yi = t.bitmap;
                    this.#ki();
                  } else this.remove();
              ...
              if (this.#Zi) {
                const t = this.#Zi;
                this.#Zi = null;
                this.#Qi = this._uiManager.imageManager.getFromUrl(t).then((t) => {
                  this.#Qi = null;
                  if (t) {
                    ({ bitmap: this.#Yi, id: this.#Ji, isSvg: this.#is } = t);
                    this.#ki();
                  } else this.remove();
                });
                return;
              ...
              this.#Qi = new Promise((e) => {
                t.addEventListener('change', async () => {
                  ...
                  if (t.files && 0 !== t.files.length) {
                    ...
                    ({ bitmap: this.#Yi, id: this.#Ji, isSvg: this.#is } = e);
                    this.#ki();
                  } else this.remove();
                  e();
                });
            ...
            remove() {
              if (this.#Ji) {
                this.#Yi = null;
                this._uiManager.imageManager.deleteId(this.#Ji);
                this.#ts?.remove();
                this.#ts = null;
                this.#yi?.disconnect();
                this.#yi = null;
            ...
            isEmpty() {
              return null === this.#Qi && null === this.#Yi && null === this.#Zi;
            }
            get isResizable() {
              return !0;
            }
            ...
            #ki() {
              ...
              const l = (this.#ts = document.createElement('canvas'));
              t.append(l);
              this.#ns(e, i);
              this.#Mi();
            ...
            #as(t, e) {
              ...
              this.setDims(t, e);
              this.fixAndSetPosition();
              null !== this.#es && clearTimeout(this.#es);
              this.#es = setTimeout(() => {
                this.#es = null;
                this.#ns(t, e);
              }, 200);
            ...
            #rs(t, e) {
              const { width: i, height: s } = this.#Yi;
              let n = i,
                a = s,
                r = this.#Yi;
              for (; n > 2 * t || a > 2 * e; ) {
            ...
            #ns(t, e) {
              ...
              i.width = t;
              i.height = e;
              const s = this.#is ? this.#Yi : this.#rs(t, e),
                n = i.getContext('2d');
            ...
            #os(t) {
              if (t) {
                if (this.#is) {
                  const t = this._uiManager.imageManager.getSvgUrl(this.#Ji);
                  if (t) return t;
                }
                const t = document.createElement('canvas');
                ({ width: t.width, height: t.height } = this.#Yi);
                t.getContext('2d').drawImage(this.#Yi, 0, 0);
                return t.toDataURL();
              }
              if (this.#is) {
                const [t, e] = this.pageDimensions,
              ...
              return structuredClone(this.#Yi);
            }
            #Mi() {
              this.#yi = new ResizeObserver((t) => {
                const e = t[0].contentRect;
                e.width && e.height && this.#as(e.width, e.height);
              });
              this.#yi.observe(this.div);
            }
            static deserialize(t, e, i) {
              ...
              const s = super.deserialize(t, e, i),
                { rect: n, bitmapUrl: a, bitmapId: o, isSvg: l } = t;
              o && i.imageManager.isValidId(o) ? (s.#Ji = o) : (s.#Zi = a);
              s.#is = l;
              const [c, h] = s.pageDimensions;
              s.width = (n[2] - n[0]) / c;
              s.height = (n[3] - n[1]) / h;
              return s;
            }
            serialize(t = !1, e = null) {
              ...
              if (t) {
                i.bitmapUrl = this.#os(!0);
                return i;
              }
              if (null === e) return i;
              e.stamps ||= new Map();
              const s = this.#is ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) : null;
              if (e.stamps.has(this.#Ji)) {
                if (this.#is) {
                  const t = e.stamps.get(this.#Ji);
                  if (s > t.area) {
                    t.area = s;
                    t.serialized.bitmap.close();
                    t.serialized.bitmap = this.#os(!1);
                  }
                }
              } else {
                e.stamps.set(this.#Ji, { area: s, serialized: i });
                i.bitmap = this.#os(!1);
              }
              return i;
            }
